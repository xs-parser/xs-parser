...
public class SimpleType implements TypeDefinition {
	...
	private static final Map<String, SimpleType> PRIMITIVE_TYPE_DEFINITIONS;
	...
	private static final Map<String, SimpleType> BUILTIN_TYPE_DEFINITIONS;
	...
	static {
		...
		primitiveTypeDefinitions.put(BOOLEAN_NAME, create(doc, BOOLEAN_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(DECIMAL_NAME, create(doc, DECIMAL_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(FLOAT_NAME, create(doc, FLOAT_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(DOUBLE_NAME, create(doc, DOUBLE_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(DURATION_NAME, create(doc, DURATION_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(DATETIME_NAME, create(doc, DATETIME_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(DATE_NAME, create(doc, DATE_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(TIME_NAME, create(doc, TIME_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(GYEARMONTH_NAME, create(doc, GYEARMONTH_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(GYEAR_NAME, create(doc, GYEAR_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(GMONTHDAY_NAME, create(doc, GMONTHDAY_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(GDAY_NAME, create(doc, GDAY_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(GMONTH_NAME, create(doc, GMONTH_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(HEXBINARY_NAME, create(doc, HEXBINARY_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(BASE64BINARY_NAME, create(doc, BASE64BINARY_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(ANYURI_NAME, create(doc, ANYURI_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(QNAME_NAME, create(doc, QNAME_NAME, xsAnyAtomicType));
		primitiveTypeDefinitions.put(NOTATION_NAME, create(doc, NOTATION_NAME, xsAnyAtomicType));
		assert primitiveTypeDefinitions.size() == 19 : primitiveTypeDefinitions.size() + ", " + primitiveTypeDefinitions;
		PRIMITIVE_TYPE_DEFINITIONS = Collections.unmodifiableMap(primitiveTypeDefinitions);
		final Map<String, SimpleType> builtinTypeDefinitions = new HashMap<>();
		builtinTypeDefinitions.put(NORMALIZEDSTRING_NAME, create(doc, NORMALIZEDSTRING_NAME, PRIMITIVE_TYPE_DEFINITIONS.get(STRING_NAME)));
		builtinTypeDefinitions.put(TOKEN_NAME, create(doc, TOKEN_NAME, builtinTypeDefinitions.get(NORMALIZEDSTRING_NAME)));
		builtinTypeDefinitions.put(LANGUAGE_NAME, create(doc, LANGUAGE_NAME, builtinTypeDefinitions.get(TOKEN_NAME)));
		builtinTypeDefinitions.put(NMTOKEN_NAME, create(doc, NMTOKEN_NAME, builtinTypeDefinitions.get(TOKEN_NAME)));
		builtinTypeDefinitions.put(NMTOKENS_NAME, create(doc, NMTOKENS_NAME, xsAnySimpleType));
		builtinTypeDefinitions.put(NAME_NAME, create(doc, NAME_NAME, builtinTypeDefinitions.get(TOKEN_NAME)));
		builtinTypeDefinitions.put(NCNAME_NAME, create(doc, NCNAME_NAME, builtinTypeDefinitions.get(NAME_NAME)));
		builtinTypeDefinitions.put(ID_NAME, create(doc, ID_NAME, builtinTypeDefinitions.get(NCNAME_NAME)));
		builtinTypeDefinitions.put(IDREF_NAME, create(doc, IDREF_NAME, builtinTypeDefinitions.get(NCNAME_NAME)));
		builtinTypeDefinitions.put(IDREFS_NAME, create(doc, IDREFS_NAME, xsAnySimpleType));
		builtinTypeDefinitions.put(ENTITY_NAME, create(doc, ENTITY_NAME, builtinTypeDefinitions.get(NCNAME_NAME)));
		builtinTypeDefinitions.put(ENTITIES_NAME, create(doc, ENTITIES_NAME, xsAnySimpleType));
		builtinTypeDefinitions.put(INTEGER_NAME, create(doc, INTEGER_NAME, PRIMITIVE_TYPE_DEFINITIONS.get(DECIMAL_NAME)));
		builtinTypeDefinitions.put(NONPOSITIVEINTEGER_NAME, create(doc, NONPOSITIVEINTEGER_NAME, builtinTypeDefinitions.get(INTEGER_NAME)));
		builtinTypeDefinitions.put(NEGATIVEINTEGER_NAME, create(doc, NEGATIVEINTEGER_NAME, builtinTypeDefinitions.get(NONPOSITIVEINTEGER_NAME)));
		builtinTypeDefinitions.put(LONG_NAME, create(doc, LONG_NAME, builtinTypeDefinitions.get(INTEGER_NAME)));
		builtinTypeDefinitions.put(INT_NAME, create(doc, INT_NAME, builtinTypeDefinitions.get(LONG_NAME)));
		builtinTypeDefinitions.put(SHORT_NAME, create(doc, SHORT_NAME, builtinTypeDefinitions.get(INT_NAME)));
		builtinTypeDefinitions.put(BYTE_NAME, create(doc, BYTE_NAME, builtinTypeDefinitions.get(SHORT_NAME)));
		builtinTypeDefinitions.put(NONNEGATIVEINTEGER_NAME, create(doc, NONNEGATIVEINTEGER_NAME, builtinTypeDefinitions.get(INTEGER_NAME)));
		builtinTypeDefinitions.put(UNSIGNEDLONG_NAME, create(doc, UNSIGNEDLONG_NAME, builtinTypeDefinitions.get(NONNEGATIVEINTEGER_NAME)));
		builtinTypeDefinitions.put(UNSIGNEDINT_NAME, create(doc, UNSIGNEDINT_NAME, builtinTypeDefinitions.get(UNSIGNEDLONG_NAME)));
		builtinTypeDefinitions.put(UNSIGNEDSHORT_NAME, create(doc, UNSIGNEDSHORT_NAME, builtinTypeDefinitions.get(UNSIGNEDINT_NAME)));
		builtinTypeDefinitions.put(UNSIGNEDBYTE_NAME, create(doc, UNSIGNEDBYTE_NAME, builtinTypeDefinitions.get(UNSIGNEDINT_NAME)));
		builtinTypeDefinitions.put(POSITIVEINTEGER_NAME, create(doc, POSITIVEINTEGER_NAME, builtinTypeDefinitions.get(NONNEGATIVEINTEGER_NAME)));
		builtinTypeDefinitions.put(YEARMONTHDURATION_NAME, create(doc, YEARMONTHDURATION_NAME, PRIMITIVE_TYPE_DEFINITIONS.get(DURATION_NAME)));
		builtinTypeDefinitions.put(DAYTIMEDURATION_NAME, create(doc, DAYTIMEDURATION_NAME, PRIMITIVE_TYPE_DEFINITIONS.get(DURATION_NAME)));
		builtinTypeDefinitions.put(DATETIMESTAMP_NAME, create(doc, DATETIMESTAMP_NAME, PRIMITIVE_TYPE_DEFINITIONS.get(DATETIME_NAME)));
		assert builtinTypeDefinitions.size() == 28;
	...
	SimpleType(final Node node, final Deque<Annotation> annotations, final String name, final String targetNamespace, final Deque<Final> finals, final Node context, final Deferred<? extends TypeDefinition> baseTypeDefinition, final Deferred<Variety> variety, final Deque<Object> facets, final Deferred<Restriction> restriction, final Deferred<List> list, final Deferred<Union> union) {
		...
		this.primitiveTypeDefinition = variety == null ? null : variety.map(v -> {
			if (Variety.ATOMIC.equals(v) && this != xsAnyAtomicType) {
				...
				assert baseTypeDefinition() instanceof SimpleType;
				return Objects.requireNonNull(((SimpleType) baseTypeDefinition()).primitiveTypeDefinition());
			}
			return null;
		});
		this.itemTypeDefinition = variety == null ? null : variety.map(v -> {
			if (Variety.LIST.equals(v)) {
				...
				assert Variety.ATOMIC.equals(itemSimpleType.variety()) || (Variety.UNION.equals(itemSimpleType.variety()) && itemSimpleType.memberTypeDefinitions().stream().allMatch(s -> Variety.ATOMIC.equals(s.variety())));
	...
	private static SimpleType parse(final Result result) {
		...
		annotations = new DeferredArrayDeque<>(() -> {
			final AnnotationSet annotationSet = restriction != null ? restriction.get().annotations()
					: list != null ? list.get().annotations()
					: union != null ? union.get().annotations()
					: AnnotationSet.EMPTY;
			return annotationSet.resolve(node);
		});
	...
	static SimpleType findPrimitiveOrBuiltinType(final String localName) {
		SimpleType s = PRIMITIVE_TYPE_DEFINITIONS.get(localName);
		if (s != null) {
			return s;
		}
	...
	public static SimpleType xsString() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(STRING_NAME));
	}
	...
	public static SimpleType xsBoolean() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(BOOLEAN_NAME));
	}
	...
	public static SimpleType xsFloat() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(FLOAT_NAME));
	}
	...
	public static SimpleType xsDouble() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(DOUBLE_NAME));
	}
	...
	public static SimpleType xsDecimal() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(DECIMAL_NAME));
	}
	...
	public static SimpleType xsDuration() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(DURATION_NAME));
	}
	...
	public static SimpleType xsDateTime() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(DATETIME_NAME));
	}
	...
	public static SimpleType xsTime() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(TIME_NAME));
	}
	...
	public static SimpleType xsDate() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(DATE_NAME));
	}
	...
	public static SimpleType xsGYearMonth() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(GYEARMONTH_NAME));
	}
	...
	public static SimpleType xsGYear() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(GYEAR_NAME));
	}
	...
	public static SimpleType xsGMonthDay() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(GMONTHDAY_NAME));
	}
	...
	public static SimpleType xsGDay() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(GDAY_NAME));
	}
	...
	public static SimpleType xsGMonth() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(GMONTH_NAME));
	}
	...
	public static SimpleType xsHexBinary() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(HEXBINARY_NAME));
	}
	...
	public static SimpleType xsBase64Binary() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(BASE64BINARY_NAME));
	}
	...
	public static SimpleType xsAnyURI() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(ANYURI_NAME));
	}
	...
	public static SimpleType xsQName() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(QNAME_NAME));
	}
	...
	public static SimpleType xsNOTATION() {
		return Objects.requireNonNull(PRIMITIVE_TYPE_DEFINITIONS.get(NOTATION_NAME));
	}
	...
	public static SimpleType xsNormalizedString() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(NORMALIZEDSTRING_NAME));
	}
	...
	public static SimpleType xsToken() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(TOKEN_NAME));
	}
	...
	public static SimpleType xsLanguage() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(LANGUAGE_NAME));
	}
	...
	public static SimpleType xsIDREFS() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(IDREFS_NAME));
	}
	...
	public static SimpleType xsENTITIES() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(ENTITIES_NAME));
	}
	...
	public static SimpleType xsNMTOKEN() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(NMTOKEN_NAME));
	}
	...
	public static SimpleType xsNMTOKENS() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(NMTOKENS_NAME));
	}
	...
	public static SimpleType xsName() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(NAME_NAME));
	}
	...
	public static SimpleType xsNCName() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(NCNAME_NAME));
	}

	/** @return <a href="http://www.w3.org/TR/xmlschema11-2/#ID">http://www.w3.org/TR/xmlschema11-2/#ID</a> */
	public static SimpleType xsID() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(ID_NAME));
	}
	...
	public static SimpleType xsIDREF() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(IDREF_NAME));
	}
	...
	public static SimpleType xsENTITY() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(ENTITY_NAME));
	}
	...
	public static SimpleType xsInteger() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(INTEGER_NAME));
	}
	...
	public static SimpleType xsNonPositiveInteger() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(NONPOSITIVEINTEGER_NAME));
	}
	...
	public static SimpleType xsNegativeInteger() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(NEGATIVEINTEGER_NAME));
	}
	...
	public static SimpleType xsLong() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(LONG_NAME));
	}

	/** @return <a href="http://www.w3.org/TR/xmlschema11-2/#int">http://www.w3.org/TR/xmlschema11-2/#int</a> */
	public static SimpleType xsInt() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(INT_NAME));
	}
	...
	public static SimpleType xsShort() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(SHORT_NAME));
	}
	...
	public static SimpleType xsByte() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(BYTE_NAME));
	}
	...
	public static SimpleType xsNonNegativeInteger() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(NONNEGATIVEINTEGER_NAME));
	}
	...
	public static SimpleType xsUnsignedLong() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(UNSIGNEDLONG_NAME));
	}
	...
	public static SimpleType xsUnsignedInt() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(UNSIGNEDINT_NAME));
	}
	...
	public static SimpleType xsUnsignedShort() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(UNSIGNEDSHORT_NAME));
	}
	...
	public static SimpleType xsUnsignedByte() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(UNSIGNEDBYTE_NAME));
	}
	...
	public static SimpleType xsPositiveInteger() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(POSITIVEINTEGER_NAME));
	}
	...
	public static SimpleType xsYearMonthDuration() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(YEARMONTHDURATION_NAME));
	}
	...
	public static SimpleType xsDayTimeDuration() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(DAYTIMEDURATION_NAME));
	}
	...
	public static SimpleType xsDateTimeStamp() {
		return Objects.requireNonNull(BUILTIN_TYPE_DEFINITIONS.get(DATETIMESTAMP_NAME));
	}
	...
	public SimpleType primitiveTypeDefinition() {
		return primitiveTypeDefinition.get();
	}
